...
`* *` | new user | visible help button | easier user access to instructions to avoid misguidance 
`* *` | user | view FAQ section | assist user in finding common answers to common questions
