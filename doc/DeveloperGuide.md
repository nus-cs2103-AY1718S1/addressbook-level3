...
5. Should not require more than 250 megabytes of storage.
6. Should have minimum size 12 font for visibility.
7. Should be able to list all persons in less than 2 seconds.
