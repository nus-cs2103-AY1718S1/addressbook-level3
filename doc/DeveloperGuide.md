...
5. Should complete any command in less than 2 seconds.
6. Should be backward compatible with earlier versions of the application,
7. Should be usable by someone who has never used a similar app before.
