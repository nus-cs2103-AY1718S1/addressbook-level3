...
`* * *` | user | see the list of contacts in the address book | view my list of friends
`* *` | user | hide [private contact details](#private-contact-detail) by default | minimize chance of someone else seeing them by accident
`* *` | user | edit contact details | modify details without having the delete contacts
`*` | user with many persons in the address book | sort persons by name | locate a person easily
`*` | user with many persons in the address book | sort persons by tag | locate a group of people easily
