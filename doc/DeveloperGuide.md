...
`* * *` | user | edit person information | update or correct person details
`* * *` | careless user | undo a delete | recover accidental deletions
`* *` | user | hide [private contact details](#private-contact-detail) by default | minimize chance of someone else seeing them by accident
`* *` | user who is bad with technology | have simple user interface | navigate the program more easily
`*` | user with many persons in the address book | sort persons by name | locate a person easily
`*` | tech-savvy user | synchronize contact information online | manage my contacts more easily
