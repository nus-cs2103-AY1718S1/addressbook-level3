...
`* *` | user | undo deletions of entries in the addressbook | undo my mistakes
`*` | user with many tags | find all entries with the same tags | find people with the same tags
