...
`* * *` | user | find who stays in a particular address | locate persons living at a particular address
...
> 3a1. AddressBook shows an error message <br>
  ...
  **MSS**
  ...
  2. AddressBook asks tag to rename and the renamed tag
  ...
  **Extensions**
  ...
  3a. The given tag to rename does not exist
  
  > 3a1. AddressBook shows an error message <br>
    Use case resumes at step 2
    
  3b. The given renamed tag is the same as the tag to rename
...
5. Should be lightweight.
6. Should be easy to use, require minimal user configuration.
