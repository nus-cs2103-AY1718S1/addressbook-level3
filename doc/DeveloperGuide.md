...
5. Should adhere to OOP and Java coding standard for any changes.
6. Should work on both 32-bit and 64-bit environments under any OS.
7. Should respond within one second.
8. Should be usable by a novice with no background
