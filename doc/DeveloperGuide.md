...
`* * *` | user | undo my last action | prevent accidents such as deletion from happening
`* *` | user | edit a person entry | change details of person without having to delete and re-add a person to change details
`* *` | user | import/export | transfer data to and from other users
