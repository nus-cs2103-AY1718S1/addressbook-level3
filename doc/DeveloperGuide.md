...
2. AddressBook confirms with the user that the rename is intended
3. AddressBook renames the tag <br>
Use case ends.
...
2a. The user indicates that they do not want to rename the tag
