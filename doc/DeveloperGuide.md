...
5. Should respond within two seconds.
6. Should be backward compatible with data produced by earlier versions of the system.
7. Should be usable by a novice who has never used an addressbook app.
