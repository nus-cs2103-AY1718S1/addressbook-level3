...
`* *` | user | be able to undo my deletion of recent contact | retrieve back my contact information if deleted accidentally
`*` | user | list persons by their tag | consolidate group of persons with the same tag
