...
5. Should be able to be used by any individual who has not used an address book before.
6. Should not showcase any unnecessary and explicit content which is unrelated to the address book.
