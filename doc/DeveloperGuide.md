...
5. Should be intuitive enough to use for users who are not IT-savvy.
6. Should use English for user interface.
7. Should have instructions that are new-user friendly.
