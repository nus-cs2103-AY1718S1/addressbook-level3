...
1. User changes one tag into another one.
2. AddressBook changes the tag.

**Extensions**

1a. AddressBook confirms the change with the user before carrying out the operation.
