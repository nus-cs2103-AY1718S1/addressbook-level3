...
`*` | user with many persons in the address book | add tags to each person | locate a person easily
`*` | user | find a person by phone number | locate the person of the phone number without having to look through the entire list
