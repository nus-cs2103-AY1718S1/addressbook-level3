...
1. User requests to see all the existing tags
2. AddressBook shows a list of all the tags
...
6. AddressBook changes the tag name
Use case ends.
...
3a. The tag to rename is invalid

> 3a1. AddressBook shows an error message
  Use case resumes at step 2

5a. User cancels change
