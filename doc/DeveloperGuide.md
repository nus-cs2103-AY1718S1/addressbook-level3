...
`* * *` | user | rename the tag of the person |  make the person into another group
`* * *` | user | find persons by tag | locate details of persons who are in the same group 
`* * *` | user | edit a person's information | update the personal information quickly
