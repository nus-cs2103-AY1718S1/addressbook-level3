...
3. User requests to add a person to the list
4. User inputs the proper format of person to be added
5. AddressBook shows a list of updated persons
Use case ends.

**Extensions**

3a. The person format is wrong or invalid

> 3a1. AddressBook shows an error with an example proper format <br>
...
4. AddressBook displays the non-private details the person <br>
Use case ends.
