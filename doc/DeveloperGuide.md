...
`* *` | user | add password to protect [private contact details](#private-contact-detail) | access the private details securely 
`*` | user with many persons in the address book | sort persons by name | locate a person easily
`*` | user | view [private contact details](#private-contact-detail) | view hidden contact details
`*` | user with many persons in the address book  | list all contacts | view all the contacts that have been stored thus far
