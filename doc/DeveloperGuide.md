...
5. Should be able to give feedback message within 2 seconds
6. Should be able to be used regardless user's IT knowledge
7. Should be able to handle invalid input format or data
