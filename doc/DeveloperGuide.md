...
3. User requests to rename a existing tag
4. AddressBook requests the confirmation from user
5. User confirms the command
6. AddressBook executes the command of renaming tag
Use case ends
...
5a. User does not give confirmation
