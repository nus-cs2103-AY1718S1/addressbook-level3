...
`* *` | user | edit information | update contact when there is change of phone number or address
`* *` | user | hide [private contact details](#private-contact-detail) by default | minimize chance of someone else seeing them by accident
`*` | user with many persons in the address book | sort persons by tag | locate particular group of people 
