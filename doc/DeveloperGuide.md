...
`* * *` | user | find a person by any of his/her details | easily locate details of persons without having to go through the entire list
`* * *` | user | edit a person | update or change details of a person when their details changed
`* *` | user | hide [private contact details](#private-contact-detail) by default | minimize chance of someone else seeing them by accident
`*` | user with many persons in the address book | sort persons by name | locate a person easily
`*` | user with many persons in the address book | create groups | group a bunch of friends/colleagues under one common tag
