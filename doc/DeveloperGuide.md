...
`* *` | user | login with social media account | automatically sync contact information
`* *` | user | navigate an intuitive application | get anything I want done with minimal effort
`* *` | user | sorts person list in order based on several fields | get information sorted in order of chosen field
