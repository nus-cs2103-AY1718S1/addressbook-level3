...
`* * *` | user | list people in address book | see the people I added to the address book
`* *` | user with many persons in the address book | find people by tag | locate groups of people easily
