...
5. Should be easy for users who have not used CLI applications before to use 
6. Should respond as quickly as possible
7. Should work on both 32-bit and 64-bit environments
8. Should not execute the command of showing pictures
