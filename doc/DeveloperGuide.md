...
`* * *` | user | edit a person's details by index | add and remove entries every time a person's details change.
`* *` | user | import details from another addressbook | so that I can get contacts more easily.  
